...
data_weights_cumlevels = data_weights_levels.cumsum().rename("cumulativecount").round().astype(int)
data_weights_levels = data_weights_cumlevels.diff().fillna(data_weights_cumlevels).astype(int).rename("overall_score")
